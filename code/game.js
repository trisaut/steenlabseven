...
var xStart = Math.floor(pos.x); //Math.floor rounds down (4.9999->4)
var xEnd = Math.ceil(pos.x + size.x); //opposite of floor aka it rounds up (4.1->5)
var yStart = Math.floor(pos.y);
var yEnd = Math.ceil(pos.y + size.y);

//Consider the sides, top, bottom of lvl as walls
...
//modifying moveX and moveY (see below)
Player.prototype.moveX = function(step, level, keys) {
  //set to 0=not moving left nor right
  this.speed.x = 0;
  //means being pressed... we substract the x speed
...
//lower=floatier
var gravity = 32;
//how quickly jumps up
var jumpSpeed = 22;
//how quickly moves up or down
var playerYSpeed = 8;

//lab in this function
...
//NOT TOUCHING KEYBOARD COMMANDS FOR PROJ
